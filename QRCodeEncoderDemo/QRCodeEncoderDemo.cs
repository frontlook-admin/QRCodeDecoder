	...
	public partial class QRCodeEncoderDemo : Form
		...
		private void OnEncode(object sender, EventArgs e)
			...
			try
				...
				// use the default ModuleSize = 2 and QuietZone = 8
		...
		/// <summary>
		/// save barcode image in PNG format 
		/// </summary>
		...
		private void CopyToClipboard()
			...
			BitmapImage.ModuleSize = ModuleSize;
			BitmapImage.QuietZone = QuietZone;
			Bitmap QRCodeBitmap = BitmapImage.CreateQRCodeBitmap();
			Clipboard.SetImage(QRCodeBitmap);
			return;
			}
		...
		private void EnableButtons
			...
			CopyButton.Enabled = QRCodeImage != null && Enabled;
			return;
			}
